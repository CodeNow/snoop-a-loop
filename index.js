...
require('./tests/private-docker-registry')(testConfiguration)
require('./tests/ssh-keys')(testConfiguration)
require('./tests/compose-extends')(testConfiguration)
require('./tests/multiple-webhooks')(testConfiguration)
